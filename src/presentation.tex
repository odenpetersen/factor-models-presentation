...
\begin{frame}{Uncertainty}
	...
	The market is \textbf{arbitrage-free} if there is no fixed set of trades that guarantees positive P\&L.
	...
	In an arbitrage-free market, $\mathbb{Q}_{t'}(\cdot)$ obeys the Kolmogorov axioms, and is therefore a \textbf{probability measure} on $\mathcal{F}_t$.%Kolmogorov (1950)

	If $\mathbb{Q}_{t'}(\omega_1)+\mathbb{Q}(\omega_2)$ exceeds $\mathbb{Q}_{t'}$
