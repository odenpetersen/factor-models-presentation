...
\begin{frame}{Batch Matching}
	...
	It is common to use this matching style at the beginning or end of a trading day or lunch break, or when there is some kind of market instability such as following a large price move or company announcement. The match time is sometimes referred to as a \textbf{liquidity event} because of the large volume traded, and the relative insensitivity of trade price to order quantity.%Price impact nonnegative because of monotonicity property
...
\begin{frame}{Continuous Matching}
	...
	$$\frac{\sum_{(s,q,\$p)\in\mathcal{M}_t} \$pq}{\sum_{(s,q,\$p)\in\mathcal{M}_t} q}.$$ %This may or may not be a multiple of the tick size.
