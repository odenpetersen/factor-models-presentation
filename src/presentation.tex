...
\begin{frame}{Market Impact Modeling}
	...
	Gatheral (2016) derives this from a variety of different models of market impact. Execution strategies are discussed here and in Johnson (2010).%Algorithmic trading and DMA
...
\begin{frame}{Market Efficiency}
	...
	However, most assets give their holder the right to potential future cashflows (`dividends'). %Exercise: find a counterexample
